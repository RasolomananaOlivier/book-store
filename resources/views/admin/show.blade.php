...
<div class="row bg-primary book-cover">
  <div class="col-5 position-relative">
    <img src="{{ asset('images/'. $book->image_path ) }}" alt="" srcset="" class="position-absolute top-50"
      style="left: 15rem; width: 300px;">
  </div>
...
<div class="container">
  <div class="row mb-5">
    ...
    <div class="col-7 d-flex flex-column">
      ...
      <div class="d-flex w-50 row">

        <div class="col-6">
          <a href="/admin/{{$book->id}}/edit" class="btn btn-outline-primary w-100">Edit</a>
        </div>
        <form action="/admin/{{$book->id}}" method="post" class="col-6">
          @csrf
          @method('delete')
